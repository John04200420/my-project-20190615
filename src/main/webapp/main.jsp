...
<jsp:include page="title.jsp"/>
		<div class="move bg1" style="position:absolute; z-index:99999; ">
			<div class="container">
				<div id="activityButton" style="height:75px;text-align:center;line-height:75px;">最新活動</div>
	...
	<div id="wrap">
		<div id="main">
			<div id="page1" class="page">
				<div id="showSign1">最新活動</div>
				<div class="flexslider">
					<ul class="slides">
						<c:forEach var="i" begin="0" end="4" step="1">
							<c:if test="${not empty clipBeanList[i]}">
								<li><img src="${pageContext.servletContext.contextPath}${clipBeanList[i].picturePath}" alt="" ></li>
							</c:if>
						</c:forEach>
...
<!-- 						<li><img src="images/T5.jpg" alt=""></li> -->
			...
			<div id="page2" class="page">
				...
				<div id="showSign4" class="wow fadeInUpBig" data-wow-duration="3.2s">最新募集版</div>
...
<!-- 					<div class="boxPer wow fadeInDownBig" data-wow-duration="3.6s"> -->
<!-- 						<div> -->
<!-- 							<a href="recommendFriend.html?keepThis=true&TB_iframe=true" class="thickbox" -->
<!-- 								rel="gallery-plants"><img src="images/4.jpg" alt=""></a> -->
<!-- 						</div> -->
<!-- 						<h3>Cindy</h3> -->
<!-- 					</div> -->
