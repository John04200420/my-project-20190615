    ...
    <form ENCTYPE="multipart/form-data" method="POST" action="<c:url value='register.do'/>"  id="theForm" >
        ...
        <div id="right">
            ...
            <div class="interest">
                ...
                <input type="checkbox" name="interest" value="game">遊戲
                <input type="checkbox" name="interest" value="video">影視
                <input type="checkbox" name="interest" value="shopp">逛街
                <input type="checkbox" name="interest" value="ballgame">打球 
                &emsp;&nbsp;&nbsp;&nbsp; &nbsp;    
                <input type="checkbox" name="interest" value="music">音樂
                <input type="checkbox" name="interest" value="travel">旅行                
                <input type="checkbox" name="interest" value="magic">魔術                
                <input type="checkbox" name="interest" value="fitness">健身                
                <input type="checkbox" name="interest" value="cook">烹飪                
            </div>
...
<!--                 <input type="submit" value="傳送出去"> -->
                ...
                <a href="index.html"><input type="button" value="回首頁"></a>
