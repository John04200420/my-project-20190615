...
@WebFilter(
		urlPatterns = { "/*" }, 
		initParams = {  
				@WebInitParam(name = "mustLogin2", value = "/main.jsp"),
				@WebInitParam(name = "mustLogin3", value = "/post/EnterEditingPageServlet")
		})

public class Filter01LoginChecking implements Filter {
